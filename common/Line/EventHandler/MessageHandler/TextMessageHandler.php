...
namespace common\Line\EventHandler\MessageHandler;
...
use common\Line\EventHandler\MessageHandler\Util\UrlBuilder;
use LINE\LINEBot;
...
class TextMessageHandler implements EventHandler
{
     ...
     */
    public function __construct($bot, $logger, \yii\web\Request $req, TextMessage $textMessage)
    {
        $this->bot = $bot;
        $this->logger = $logger;
        $this->req = $req;
        ...
        switch ($text) {
            ...
            case 'สถานะคิว':
                ...
                if (empty($patient)) {
                    ...
                    if (empty($items)) {
                        $this->bot->replyText($replyToken, 'ไม่พบรายการคิวของคุณ');
                    } else {
